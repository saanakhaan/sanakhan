  ...
  const projects = [
    {
      ...
      description: <a href="https://pakpost.gov.pk/testppo/">Full Stack Website for Pakistan Post in ReactJs. Click to open</a>,
      imgUrl: projImg1,
    },
    {
      description: "Full Stack Java application for Workshop management system",
      imgUrl: projImg2,
    }
  ];
